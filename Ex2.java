class Exceptional{
    public static void main(String[] args) {
        ...
        System.out.println("Program continue after handlin the exeption.");
...
class Exception2{
    public static void main(String[] args){
        ...
        try{
            ...
            System.out.println("cannot call method on a null obj");
        }
    }
}
...
class Exceptionthrows
{
    ...
    public static void methodThatThrowsException() throws Exception {
        throw new Exception("This is a custome exeption message .");
    }
}
...
class ExceptionMyException {
    ...
    public static void validateAge(int age) throws myexception {
        if (age < 18) {
            throw new myexception("Age must be at least 18. Provide age:" +age);
        }
    }
}